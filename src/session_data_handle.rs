...
// use axum_session_mongo::SessionMongoSessionStore;
// use log::trace;
...
//     pub session_store: SessionMongoSessionStore,
// }
...
//         let Extension(store) = Extension::<SessionMongoSessionStore>::from_request_parts(parts, state)
//             .await
//             .expect("`SessionMongoSessionStore` extension missing");
...
// async fn create_new_session(store: SessionMongoSessionStore) -> FreshSessionData {
