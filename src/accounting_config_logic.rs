...
impl<'a> FinanceAccountingConfigHandle<'a> {
    ...
    pub fn finance_account_type_list(&self) -> Result<Vec<FinanceAccountType>, String> {
        let temp_var_1 =
            executor::block_on(self.db_connector.finance_account_type_list(&self.user_id));
    ...
    pub async fn finance_account_list_async(
        ...
        let temp_var_1 = self
            .db_connector
            .finance_account_list(&self.user_id, limit_account_ids)
            .await;
        return temp_var_1;
    }
    ...
    pub fn finance_account_upsert(
        ...
        let temp_var_1 = self
            .db_connector
            .finance_account_upsert(&self.user_id, finance_account);
